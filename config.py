...
EXPO_PUSH_ENABLED = os.getenv("VOSS_EXPO_PUSH_ENABLED", "1").strip() not in {"0", "false", "False"}
...
BACKGROUND_REMINDER_INTERVAL_SECONDS = int(os.getenv("VOSS_BACKGROUND_REMINDER_INTERVAL_SECONDS", "45"))
